    ...
    public sealed partial class UpdateManager
    {
        internal class ApplyReleasesImpl : IEnableLogger
        {
            ...
            public async Task<string> ApplyReleases(UpdateInfo updateInfo, bool silentInstall, bool attemptingFullInstall, Action<int> progress = null)
            {
                ...
                progress(0);
                var ret = await installFromDelta(updateInfo);
                progress(10);
            ...
            //async Task<ReleaseEntry> createFullPackagesFromDeltasBackup(IEnumerable<ReleaseEntry> releasesToApply, ReleaseEntry currentVersion)
            //{
